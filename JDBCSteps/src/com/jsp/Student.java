...
public class Student {
	public static void main(String[] args) {
		...
		// String insertQuery1="insert into student_details VALUES ('103', ' Jack',
		// '77', 'M', 'jack@gmail.com', 'jack123',75,It)";
		// String update="update student_details set std_password='alice321' where
		// std_email='alice@gmail.com',Mech";
