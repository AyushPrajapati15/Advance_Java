...
public class Product {
	public static void main(String[] args) {
		...
		/*
		 * String
		 * insertQuery="insert into product VALUES (101,'iPhone',100,'Apple',55000)";
		 * String
		 * insertQuery1="insert into product VALUES (102,'shirts',80,'levis',2500)";
		 * String
		 * insertQuery2="insert into product VALUES (103,'jeans',150,'wrangler',3500)";
		 */
		try {
